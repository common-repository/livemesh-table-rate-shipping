...
class LTRS_Ajax_Helper {
	...
	public function __construct() {
		// Update elements
		add_action( 'wp_ajax_ltrs_update_condition_value', array( $this, 'update_condition_value' ) );
	...
	public function update_condition_value() {
		...
		$lwc_condition     = new LTRS_Condition( $id, $group, $condition );
