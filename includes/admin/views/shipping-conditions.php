...
<div class='lwc-conditions'>
    <div class='lwc-condition-groups'>
        ...
        <p>
            <strong><?php _e('Match one of the condition groups to allow this shipping rate:', 'livemesh-tr-shipping'); ?></strong>
        </p><?php
    ...
    <a class='button lwc-condition-group-add'
       href='javascript:void(0);'><?php _e('Add \'Or\' group', 'livemesh-tr-shipping'); ?></a>
</div>
