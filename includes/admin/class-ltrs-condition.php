...
class LTRS_Condition {
    ...
    public function get_conditions() {
        return ltrs_get_method_conditions();
    ...
    public function get_operators() {
        ...
        return apply_filters('ltrs_operators', $lwc_condition->get_operators(), $lwc_condition);
    }
    ...
    public function get_value_field_args() {
        ...
        $field_args = apply_filters('ltrs_values', $field_args, $this->condition);
    ...
    public function get_description() {
        $descriptions = apply_filters('ltrs_descriptions', lwc_condition_descriptions());
